...
Project Structure:
- `internal/memory`: Harness-wide persistent memory storage.
- `internal/mcpserver`: MCP server implementation providing tools for runs, memory, and skills.
- `internal/config`: Ariadne configuration, including skill definitions.
